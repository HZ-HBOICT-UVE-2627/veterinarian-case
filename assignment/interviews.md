...
This document contains five interview transcripts conducted with stakeholders at a fictional veterinary practice (Veterinary Clinic Van Dijk). The interviews were conducted as part of a requirements elicitation exercise for a new integrated practice management system.
...
| **Interview 1** | Dr. Alex van Dijk — Practice owner, lead vet |
| --- | --- |
| **Interview 2** | Jamie Kaya — Senior receptionist |
| **Interview 3** | Robin Jansen — Veterinary assistant |
| **Interview 4** | Noor de Boer — Pet owner (client) |
| **Interview 5** | Taylor Visser — Lab technician (external partner) |

---

# Interview 1 — Dr. Alex van Dijk
...
Dr. van Dijk, thank you for making time. Could you start by describing the practice and your role here?

**Dr. van Dijk** _Practice Owner_
...
It means our receptionists are doing a lot of things manually that really shouldn't be manual anymore. If a client wants to know when their dog's next vaccination is due, Jamie has to open the record, scroll through, find the last vaccination date, calculate the interval themself, and then call or email the client. There's no automated reminder system. We do it with a printed calendar on the wall and sticky notes.
...
Jamie, can you walk me through what a typical Monday morning looks like for you?

**Jamie** _Receptionist_
...
Dr. van Dijk mentioned he'd like to introduce online appointment booking. What's your reaction to that?
...
> ⚠️ **Teaching note:** Tension to flag: Jamie's resistance to online booking stems from legitimate workflow concerns (slot sizing, no-shows), not just technophobia. Students should distinguish valid functional concerns from change resistance.

---

# Interview 3 — Robin Jansen
...
| **Interview context** | Conducted in the prep room during a quieter period. Robin was eager to talk. |

## Opening — Enthusiasm & Current Pain Points

**Interviewer** _Student_

Robin, what does your day-to-day look like in terms of the systems you use?

**Robin** _Veterinary Assistant_
...
> 📌 **Annotation:** Confirms Dr. van Dijk's account: lab result pipeline is fully manual — PDF → email → manual entry.
...
Did you raise that with Dr. van Dijk?
...
I update a spreadsheet every Friday. I count what's in the cabinet, compare it to last week, and if anything is getting low I flag it to Dr. van Dijk or the office manager. It's not... systematic. Last month we ran out of ketamine — not a good situation — because I was sick the Friday before and no one else checked.
...
Full replacement, honestly. VetBase is the root cause of half the problems. But I know that's a bigger project and Dr. van Dijk will worry about the data migration. Jamie will worry about having to learn a new system. So politically... it's complicated.

> ⚠️ **Teaching note:** Tech-savvy stakeholder introducing scope and architecture risk. Students should identify: (1) HL7 lab integration as a near-term quick win, (2) full replacement vs. integration layer as a key architectural decision, (3) Robin's enthusiasm may lead to gold-plating — distinguish must-have from nice-to-have.

---

# Interview 4 — Noor de Boer
...
Noor de Boer, thank you for agreeing to speak with us. Can you tell me how you currently interact with the veterinary practice?

**Noor de Boer** _Pet Owner / Client_

Well, I just call them when I need something. Benji is getting older so he needs his checks more often now, and Roos had a skin condition last spring. I always speak to Jamie — she's lovely. I call, she tells me when there's a slot, and I write it in my diary. That's how it works.
...
[pause] An app? On my phone? My granddaughter keeps trying to get me to use apps but I find them complicated. Everything is so small on the screen and you have to register and remember passwords... I don't know. Maybe if it was very simple. But I'd probably still just call Jamie.
...
Jamie calls me the day before an appointment, yes. That's very helpful because I sometimes forget. [laughs] But for vaccinations — I have to be honest, I'm not always sure when they're due. I rely on Jamie to tell me. Last year Roos was apparently overdue by six weeks before anyone noticed. I felt terrible about that.
...
| **Interview context** | Video call. Taylor joins from his office. Direct and technically precise. |

## Opening — Current Integration Method

**Interviewer** _Student_

Taylor, thanks for joining us. Can you describe how the current process works between your lab and the veterinary practice?

**Taylor** _Lab Technician / Integration Specialist_
...
Honestly? Small practices don't have IT people. This practice has no one who could configure an HL7 endpoint, set up an MLLP listener, or map the patient identifiers between systems. That's not a criticism — it's just the reality. When we integrate with a large hospital, there's an IT department. When we integrate with a four-vet practice, there's... Jamie. Who, from what I understand, still prints the calendar.
